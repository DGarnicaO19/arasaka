...
<head>
    ...
    <meta name="author" content="Laura López">
    {{-- styles --}}
    ...
    <div class="container">
        <div class="navbar">
            ...
            <div class="navbar-user">
                <p>Logged como {{auth()->user()->name}}</p>
                <form action="{{route('logout')}}" method="POST">
                    @csrf
                    @method('put')
                    <button type="submit">(<span>Salir</span>)</button>
                </form>
            </div>
        </div>
        <main>
            <div class="navbar-left">
                <div class="navbar-left-body">
                    <ul>
                        ...
                        <li><a href="{{route('dashboard.products')}}" class="{{currentRoute('dashboard/products')?'active':''}}">Empresas</a></li>
                        <li><a href="{{route('dashboard.profile')}}" class="{{currentRoute('dashboard/profile')?'active':''}}">Perfil</a></li>
                    </ul>
                </div>
